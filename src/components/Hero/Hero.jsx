      ...
      <div className="container pb-8 sm:pb-0">
        <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            <div className='order-2 sm:order-1 flex flex-col justify-center gap-6'>
                ...
                <span className='text-primary font-cursive'>Coffee</span> in the city</h1>
                <div>
            ...
            sm:order-2 relative'>
                ...
                <div className='bg-gradient-to-r from-primary to-secondary absolute top-10 
                left-10 p-3 rounded-xl'>
                    <h1>
                    Hey Coder
                    </h1>
                </div>
                <div className='bg-gradient-to-r from-primary to-secondary absolute bottom-10 
                right-10 p-3 rounded-xl'>
                    <h1>
                    Best Coffee
                    </h1>
                </div>
